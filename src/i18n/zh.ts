...
export const zh: TranslationType = {
    ...
    protocol: {
        badge: '革命性代币标准',
        heroTitle: '市场',
        heroTitleGradient: '证明',
        heroSubtitle: '价格是唯一的解锁钥匙。不是时间，不是 VC 投票，而是市场参与者用真金白银投票形成的价格共识。',
        heroQuote: '代码比人性更安全',
        stats: {
            totalSupply: '总供应量',
            unlockRounds: '解锁轮次',
        ...
        mechanism: {
            title: 'PoM 机制流程',
            step1Title: '价格达标',
            step1Desc: '市场价格达到当前轮次目标',
            step2Title: '72小时共识',
            step2Desc: '价格必须维持在目标之上',
            step3Title: '自动解锁',
            step3Desc: '合约自动分发 50亿 TAI',
            circuitBreaker: '熔断机制',
            circuitBreakerDesc: '价格跌破目标，计时器归零',
        },
        rounds: {
            title: '18轮价格里程碑',
            subtitle: '从 $0.00008 到 $1.98 — {growth}倍增长',
            roundLabel: '轮次',
            multiplier: '增长倍数',
            unlockAmount: '解锁量',
            consensus: '共识期',
        ...
        comparison: {
            title: '传统模式 vs TAI PoM',
            traditional: '传统时间解锁',
            unlockCondition: '解锁条件',
            timePasses: '时间流逝',
            priceTarget: '价格目标 + 72h',
            circuitBreaker: '熔断机制',
            none: '无',
            autoReset: '自动重置',
            teamConstraint: '团队约束',
            ...
            low: '低',
            veryHigh: '极高',
            traditionalFooter: '92% 项目使用此模式',
            taiFooter: '无业绩，无流动性',
        },
        rules: {
            title: '铁律',
            codeIsLaw: '代码即法律',
            codeIsLawDesc: '智能合约是唯一的裁判，没有后门，没有例外',
            noPerformance: '无业绩无流动性',
            noPerformanceDesc: '价格不达标，一枚代币都流不出',
            onChain: '链上透明',
            onChainDesc: '所有规则写在合约里，任何人可验证',
            marketProof: '市场证明',
            marketProofDesc: '真金白银的价格共识，不是 VC 投票',
        },
        cta: {
            whitepaper: '阅读白皮书',
            launchApp: '启动应用',
    ...
    ecosystemPage: {
        title: 'TAI 生态系统',
        titleAccent: '合约架构',
        subtitle: '10个智能合约 · TON主网部署 · 完全去中心化',
        ...
        staking: {
            ...
            totalYield: '总收益',
            noLockup: '无锁定期',
            withdrawAnytime: '随时提取',
            flexibleLimit: '每轮限额 1000亿 TAI',
            principalUnlock: '本金第12轮解锁',
            rewardsUnlock: '收益第18轮解锁',
            fixedLimit: '总限额 900亿 TAI',
        },
        governance: {
            title: '治理机制',
            pomTitle: '市场证明 (PoM)',
            pomDesc: 'TAI Protocol 的治理由市场价格共识驱动。代码即法律，价格是唯一的钥匙。',
            withdrawThreshold: '团队/基金池提取门槛',
            consensusPeriod: '价格共识期',
            unlockRounds: '解锁轮次',
        },
        apps: {
            title: '生态应用',
            falemeTitle: '发了么 (TAI Wealth Node)',
            falemeDesc: '游戏化的加密货币财富管理平台。设定目标、追踪进度、赢取奖励。',
            tagWealth: '财富管理',
            tagGamified: '游戏化',
        },
        footer: {
